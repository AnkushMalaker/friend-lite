...
class BackgroundTaskManager:
    ...
    def track_task(self, task: asyncio.Task, name: str, metadata: Optional[Dict[str, Any]] = None):
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "healthy": len(active_tasks) < 1000 and (oldest_task[1] < 3600 if oldest_task else True)
        }
