...
class ProcessorManager:
    ...
    async def queue_memory(self, item: MemoryProcessingItem):
        ...
        audio_logger.info(f"✅ Successfully enqueued memory processing to RQ for conversation {item.conversation_id}, job_id: {job.id}")
    ...
    async def queue_cropping(self, item: AudioCroppingItem):
        ...
        audio_logger.info(f"✅ Successfully enqueued audio cropping to RQ for audio {item.audio_uuid}, job_id: {job.id}")
